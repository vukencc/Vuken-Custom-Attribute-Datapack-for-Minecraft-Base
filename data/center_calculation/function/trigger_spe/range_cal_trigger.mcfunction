...
execute store result score @s projectile_protection_p1 run data get entity @s equipment.head.components."minecraft:enchantments"."minecraft:projectile_protection" 2
execute store result score @s projectile_protection_p2 run data get entity @s equipment.chest.components."minecraft:enchantments"."minecraft:projectile_protection" 2
execute store result score @s projectile_protection_p3 run data get entity @s equipment.legs.components."minecraft:enchantments"."minecraft:projectile_protection" 2
execute store result score @s projectile_protection_p4 run data get entity @s equipment.feet.components."minecraft:enchantments"."minecraft:projectile_protection" 2
execute store result score @s projectile_protection_p5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."minecraft:projectile_protection" 2
execute store result score @s projectile_protection_p6 run data get entity @s SelectedItem.components."minecraft:enchantments"."minecraft:projectile_protection" 2
...
scoreboard players operation @s projectile_protection_p1 += @s projectile_protection_p2
scoreboard players operation @s projectile_protection_p1 += @s projectile_protection_p3
scoreboard players operation @s projectile_protection_p1 += @s projectile_protection_p4
scoreboard players operation @s projectile_protection_p1 += @s projectile_protection_p5
scoreboard players operation @s projectile_protection_p1 += @s projectile_protection_p6
scoreboard players operation @s projectile_protection_p1 += @s protection_p1
scoreboard players operation @s projectile_protection_p1 += @s protection_p2
scoreboard players operation @s projectile_protection_p1 += @s protection_p3
scoreboard players operation @s projectile_protection_p1 += @s protection_p4
scoreboard players operation @s projectile_protection_p1 += @s protection_p5
scoreboard players operation @s projectile_protection_p1 += @s protection_p6
execute if score @s projectile_protection_p1 matches 25.. run scoreboard players set @s projectile_protection_p1 24
...
scoreboard players operation @s projectile_protection_p1 *= @s temp_std4
scoreboard players operation @s temp_std100 -= @s projectile_protection_p1
...
execute store result score @s range_evasion_p1 run data get entity @s equipment.head.components."minecraft:enchantments"."center_calculation:defence/range_evasion" 2
execute store result score @s range_evasion_p2 run data get entity @s equipment.chest.components."minecraft:enchantments"."center_calculation:defence/range_evasion" 2
execute store result score @s range_evasion_p3 run data get entity @s equipment.legs.components."minecraft:enchantments"."center_calculation:defence/range_evasion" 2
execute store result score @s range_evasion_p4 run data get entity @s equipment.feet.components."minecraft:enchantments"."center_calculation:defence/range_evasion" 2
execute store result score @s range_evasion_p5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."center_calculation:defence/range_evasion" 2
execute store result score @s range_evasion_p6 run data get entity @s SelectedItem.components."minecraft:enchantments"."center_calculation:defence/range_evasion" 2
...
scoreboard players set @s range_damage_timing 0
