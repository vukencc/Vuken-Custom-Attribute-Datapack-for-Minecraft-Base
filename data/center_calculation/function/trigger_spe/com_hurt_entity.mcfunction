...
execute as @s at @s run summon marker ~ ~ ~ {Tags:["temp_melee_inner"],data:{bleed:0.0,combo:0.0,crit:0.0,current:0.0,curse:0.0,first_strike:0.0,focus:0.0,quake:0.0,slayer:0.0,thunder_aspect:0}}
