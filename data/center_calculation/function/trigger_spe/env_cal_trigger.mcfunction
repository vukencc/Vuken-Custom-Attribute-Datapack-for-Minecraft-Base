...
execute store result score @s env_protection_p6 run data get entity @s SelectedItem.components."minecraft:enchantments"."center_calculation:defence/env_protection" 2
