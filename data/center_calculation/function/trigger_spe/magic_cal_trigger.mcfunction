...
execute store result score @s magic_protection_p1 run data get entity @s equipment.head.components."minecraft:enchantments"."center_calculation:defence/magic_protection" 2
execute store result score @s magic_protection_p2 run data get entity @s equipment.chest.components."minecraft:enchantments"."center_calculation:defence/magic_protection" 2
execute store result score @s magic_protection_p3 run data get entity @s equipment.legs.components."minecraft:enchantments"."center_calculation:defence/magic_protection" 2
execute store result score @s magic_protection_p4 run data get entity @s equipment.feet.components."minecraft:enchantments"."center_calculation:defence/magic_protection" 2
execute store result score @s magic_protection_p5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."center_calculation:defence/magic_protection" 2
execute store result score @s magic_protection_p6 run data get entity @s SelectedItem.components."minecraft:enchantments"."center_calculation:defence/magic_protection" 2
...
execute if score @s magic_protection_p1 matches 25.. run scoreboard players set @s magic_protection_p1 24
...
scoreboard players operation @s magic_protection_p1 *= @s temp_std4
...
execute store result score @s magic_evasion_p1 run data get entity @s equipment.head.components."minecraft:enchantments"."center_calculation:defence/magic_evasion" 2
execute store result score @s magic_evasion_p2 run data get entity @s equipment.chest.components."minecraft:enchantments"."center_calculation:defence/magic_evasion" 2
execute store result score @s magic_evasion_p3 run data get entity @s equipment.legs.components."minecraft:enchantments"."center_calculation:defence/magic_evasion" 2
execute store result score @s magic_evasion_p4 run data get entity @s equipment.feet.components."minecraft:enchantments"."center_calculation:defence/magic_evasion" 2
execute store result score @s magic_evasion_p5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."center_calculation:defence/magic_evasion" 2
execute store result score @s magic_evasion_p6 run data get entity @s SelectedItem.components."minecraft:enchantments"."center_calculation:defence/magic_evasion" 2
...
scoreboard players set @s magic_damage_timing 0
