...
execute store result score @s agility_p1 run data get entity @s equipment.head.components."minecraft:enchantments"."center_calculation:assistance/agility"
execute store result score @s agility_p2 run data get entity @s equipment.chest.components."minecraft:enchantments"."center_calculation:assistance/agility"
execute store result score @s agility_p3 run data get entity @s equipment.legs.components."minecraft:enchantments"."center_calculation:assistance/agility"
execute store result score @s agility_p4 run data get entity @s equipment.feet.components."minecraft:enchantments"."center_calculation:assistance/agility"
execute store result score @s agility_p5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."center_calculation:assistance/agility"
...
execute as @s at @s run function center_calculation:data_refresh/agility_apply with entity @n[tag=temp_agility,type=marker] data
...
execute as @s at @s run function center_calculation:data_refresh/safe_fall_apply with entity @n[tag=temp_agility,type=marker] data

kill @n[tag=temp_agility,type=marker]

tag @s remove reg_trans_access
execute store result score @s regeneration_p1 run data get entity @s equipment.head.components."minecraft:enchantments"."center_calculation:assistance/regeneration" 10
execute store result score @s regeneration_p2 run data get entity @s equipment.chest.components."minecraft:enchantments"."center_calculation:assistance/regeneration" 10
execute store result score @s regeneration_p3 run data get entity @s equipment.legs.components."minecraft:enchantments"."center_calculation:assistance/regeneration" 10
execute store result score @s regeneration_p4 run data get entity @s equipment.feet.components."minecraft:enchantments"."center_calculation:assistance/regeneration" 10
execute store result score @s regeneration_p5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."center_calculation:assistance/regeneration" 10
