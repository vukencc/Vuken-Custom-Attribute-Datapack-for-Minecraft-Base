...
execute if score @s env_damage_timing matches 1 at @s run function center_calculation:trigger_spe/env_cal_trigger
...
execute if score @s data_delay matches 1 at @s run function center_calculation:data_refresh/defence_count
...
execute if score @s spawner_break matches 1.. at @s run function center_calculation:custom_ench/assistance/spawner_break
execute if score @s invert_delay matches 1 at @s run advancement revoke @s only center_calculation:effects_changed
...
execute if predicate {condition:"entity_properties",entity:"this",predicate:{flags:{is_sneaking:true}}} at @s run function center_calculation:item_spe/frc_trigger/is_sneaking
execute if predicate {condition:"entity_properties",entity:"this",predicate:{flags:{is_sneaking:false}}} at @s run function center_calculation:item_spe/frc_trigger/not_sneaking
