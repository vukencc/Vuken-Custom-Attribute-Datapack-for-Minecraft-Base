...
execute as @p[tag=tempApply] run function center_calculation:damage/range/calculation
scoreboard players operation @s enemy.Taken.Range *= @p[tag=tempApply] stdTemp1
execute store result entity @s data.MeleeTaken double 0.00001 run scoreboard players get @s enemy.Taken.Range
