...
tag @p add tempApply
execute if score @p melee_quake matches 1.. as @p at @s positioned ^ ^ ^2.3 as @e[type=!#minecraft:bypass,distance=..3,nbt={HurtTime:0s}] run function center_calculation:damage/melee/direct_apply
