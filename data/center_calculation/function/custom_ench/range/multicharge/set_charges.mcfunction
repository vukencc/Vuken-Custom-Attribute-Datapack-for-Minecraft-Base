...
execute store result score @s stdTemp1 run data get entity @s SelectedItem.components."minecraft:enchantments"."minecraft:multishot" 2
scoreboard players add @s stdTemp1 1
scoreboard players operation @s range_multicharge *= @s stdTemp1