execute if entity @s[nbt={SelectedItem:{components:{"minecraft:enchantments":{"center_calculation:range/gravity":1}}}}] at @s as @e[type=#arrows,nbt=!{pickup:0b},distance=..2.5] run data merge entity @s {NoGravity:1b}
execute if entity @s[nbt={equipment:{offhand:{components:{"minecraft:enchantments":{"center_calculation:range/gravity":1}}}}}] at @s as @e[type=#arrows,nbt=!{pickup:0b},distance=..2.5] run data merge entity @s {NoGravity:1b}
#buff_transform
