...
execute if score @s range_greed matches 0 store result score @s range_greed run data get entity @s SelectedItem.components."minecraft:enchantments"."center_calculation:range/greed"
...
execute if score @s range_freeze matches 0 store result score @s range_freeze run data get entity @s SelectedItem.components."minecraft:enchantments"."center_calculation:range/freeze"
...
execute if score @s range_ring matches 0 store result score @s range_ring run data get entity @s SelectedItem.components."minecraft:enchantments"."center_calculation:range/ring"
...
execute if score @s range_starlit matches 0 store result score @s range_starlit run data get entity @s SelectedItem.components."minecraft:enchantments"."center_calculation:range/starlit"
