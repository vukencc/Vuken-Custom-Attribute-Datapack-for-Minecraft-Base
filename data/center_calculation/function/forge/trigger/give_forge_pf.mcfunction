...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:custom_data":{PassiveSlot:1}}}}] if items entity @s weapon.mainhand book run item replace entity @s weapon.mainhand with air
