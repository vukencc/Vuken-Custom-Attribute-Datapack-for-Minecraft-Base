...
execute if score @p stdTemp1 matches 1 run data modify entity @n[tag=forge_show] item.components."minecraft:lore".[0].extra.[1] set value {text:"★☆☆",color:"#2dfd5a",italic:false}
execute if score @p stdTemp1 matches 2 run data modify entity @n[tag=forge_show] item.components."minecraft:lore".[0].extra.[1] set value {text:"★★☆",color:"#3d31eb",italic:false}
execute if score @p stdTemp1 matches 3 run data modify entity @n[tag=forge_show] item.components."minecraft:lore".[0].extra.[1] set value {text:"★★★",color:"#781ca3",italic:false}
