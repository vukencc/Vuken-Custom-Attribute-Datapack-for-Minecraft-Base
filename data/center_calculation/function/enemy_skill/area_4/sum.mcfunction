...
effect give @a[scores={a4_poison=301..400}] hunger 1 3 true
effect give @a[scores={a4_poison=401..500}] hunger 1 4 true
effect give @a[scores={a4_poison=501..600}] hunger 1 5 true
effect give @a[scores={a4_poison=601..700}] hunger 1 6 true