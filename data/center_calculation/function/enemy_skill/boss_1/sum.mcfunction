execute unless entity @e[tag=boss_4] run function center_calculation:enemy_skill/boss_1/victory
execute unless entity @p[scores={boss.temp_deaths=0}] if entity @e[tag=boss_4] run function center_calculation:enemy_skill/boss_1/failed
