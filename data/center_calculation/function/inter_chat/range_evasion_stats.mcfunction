...
execute store result score @s range_evasion_p6 run data get entity @s equipment.mainhand.components."minecraft:enchantments"."center_calculation:defence/range_evasion" 2
