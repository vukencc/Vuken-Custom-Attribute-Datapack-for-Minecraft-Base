...
execute store result score @s magic_protection_p6 run data get entity @s equipment.mainhand.components."minecraft:enchantments"."center_calculation:defence/magic_protection" 2
...
tellraw @s [{translate:name.magic_defence.lore,"fallback":"Magic Damage Defence : ",color:white,bold:true},{score:{name:"@s",objective:"temp_100"},color:"#ade6ff",bold:true},{"text":"%",color:"#ade6ff",bold:true}]
#clear
