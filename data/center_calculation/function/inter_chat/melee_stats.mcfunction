...
execute store result score @s melee_protection_p6 run data get entity @s equipment.mainhand.components."minecraft:enchantments"."center_calculation:defence/melee_protection" 2
...
tellraw @s [{translate:name.melee_defence.lore,"fallback":"Melee Damage Defence : ",color:white,bold:true},{score:{name:"@s",objective:"temp_100"},color:"#ade6ff",bold:true},{"text":"%",color:"#ade6ff",bold:true}]
#clear
