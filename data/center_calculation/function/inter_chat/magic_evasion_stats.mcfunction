...
execute store result score @s magic_evasion_p6 run data get entity @s equipment.mainhand.components."minecraft:enchantments"."center_calculation:defence/magic_evasion" 2
