...
execute store result score @s melee_evasion_p6 run data get entity @s equipment.mainhand.components."minecraft:enchantments"."center_calculation:defence/melee_evasion" 2
