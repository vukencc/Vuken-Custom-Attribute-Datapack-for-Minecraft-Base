...
execute if score @s stdTemp1 matches 1.. at @s run function center_calculation:item_spe/base_item/anvil/anvil_return with entity @n[type=marker,tag=anvil_return] data
