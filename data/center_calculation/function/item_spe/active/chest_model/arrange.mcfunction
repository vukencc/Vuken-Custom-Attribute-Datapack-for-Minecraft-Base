...
execute if data entity @n[type=armor_stand,tag=stdTemp4] equipment.head.components."minecraft:custom_data".PotionCharger.[0] run function center_calculation:item_spe/active/chest_model/arrange with entity @n[type=marker,tag=stdTemp2] data
