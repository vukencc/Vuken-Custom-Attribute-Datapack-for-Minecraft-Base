...
summon armor_stand ~ ~ ~ {NoAI:1b,Invisible:1b,Marker:1b,Invulnerable:1b,Tags:["stdTemp4"]}
...
function center_calculation:item_spe/active/chest_model/arrange with entity @n[type=marker,tag=stdTemp2] data
...
execute at @s anchored eyes positioned ^ ^ ^1.5 run function center_calculation:particle/skill/cm/sphere
