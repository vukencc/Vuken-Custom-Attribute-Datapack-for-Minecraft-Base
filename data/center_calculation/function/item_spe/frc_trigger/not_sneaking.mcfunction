...
execute if items entity @s player.cursor *[custom_data~{AnvilUsing:1b}] run function center_calculation:item_spe/base_item/anvil/anvil_reset
execute if items entity @s weapon.offhand *[custom_data~{AnvilUsing:1b}] run function center_calculation:item_spe/base_item/anvil/bundle_offhand_reset
execute if items entity @s player.crafting.* anvil[custom_data~{AnvilFix:1b}] run function center_calculation:item_spe/base_item/anvil/prime
...
execute unless score @s cursor.count.B = @s cursor.count.A run function center_calculation:item_spe/cursor_changed
