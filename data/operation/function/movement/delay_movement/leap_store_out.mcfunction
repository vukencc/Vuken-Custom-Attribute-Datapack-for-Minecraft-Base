data merge entity @s {Invulnerable:1b,IsBaby:1b,active_effects:[{id:invisibility,duration:9999999,amplifier:0,show_particles:0b}],attributes:[{base:0.1,id:scale},{base:0,id:max_health},{base:0,id:follow_range}],Motion:[0.0,0.4,0.0],Tags:["delay.leap_center.out.carrier","timing_limited","timing_limited_10"],DeathLootTable:""}
