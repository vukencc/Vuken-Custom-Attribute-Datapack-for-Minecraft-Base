...
execute if score $s_vir dungeon_y1 > $s_vir dungeon_y2 run scoreboard players add $s_vir dungeon_x1 20
...
# z_final -> x, y+=1, z=0
execute if score $s_vir dungeon_z1 > $s_vir dungeon_z2 run scoreboard players add $s_vir dungeon_y1 20
...
# x, y, z+=1
scoreboard players add $s_vir dungeon_z1 20