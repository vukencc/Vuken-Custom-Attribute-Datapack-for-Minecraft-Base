...
execute store result score @s env_protection_p6 run data get entity @s SelectedItem.components."minecraft:enchantments"."core:defence/env_protection" 2
...
advancement revoke @s only core:env_taken