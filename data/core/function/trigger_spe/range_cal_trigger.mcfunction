...
execute store result score @s range_evasion_p6 run data get entity @s SelectedItem.components."minecraft:enchantments"."core:defence/range_evasion" 2
...
execute as @s at @s if score @s damageResisted >= @s damageDeathDetect if entity @s[tag=death_totem] run function core:trigger_spe/death_escape
#damage_export
