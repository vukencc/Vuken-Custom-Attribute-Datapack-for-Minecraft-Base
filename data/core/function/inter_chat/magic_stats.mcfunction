...
execute store result score @s magic_protection_p1 run data get entity @s equipment.head.components."minecraft:enchantments"."core:defence/magic_protection" 2
execute store result score @s magic_protection_p2 run data get entity @s equipment.chest.components."minecraft:enchantments"."core:defence/magic_protection" 2
execute store result score @s magic_protection_p3 run data get entity @s equipment.legs.components."minecraft:enchantments"."core:defence/magic_protection" 2
execute store result score @s magic_protection_p4 run data get entity @s equipment.feet.components."minecraft:enchantments"."core:defence/magic_protection" 2
execute store result score @s magic_protection_p5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."core:defence/magic_protection" 2
execute store result score @s magic_protection_p6 run data get entity @s equipment.mainhand.components."minecraft:enchantments"."core:defence/magic_protection" 2
