...
execute store result score @s melee_evasion_p1 run data get entity @s equipment.head.components."minecraft:enchantments"."core:defence/melee_evasion" 2
execute store result score @s melee_evasion_p2 run data get entity @s equipment.chest.components."minecraft:enchantments"."core:defence/melee_evasion" 2
execute store result score @s melee_evasion_p3 run data get entity @s equipment.legs.components."minecraft:enchantments"."core:defence/melee_evasion" 2
execute store result score @s melee_evasion_p4 run data get entity @s equipment.feet.components."minecraft:enchantments"."core:defence/melee_evasion" 2
execute store result score @s melee_evasion_p5 run data get entity @s equipment.offhand.components."minecraft:enchantments"."core:defence/melee_evasion" 2
execute store result score @s melee_evasion_p6 run data get entity @s equipment.mainhand.components."minecraft:enchantments"."core:defence/melee_evasion" 2
...
tellraw @s [{translate:name.melee_evasion.lore,"fallback":"Melee Evasion Chance : ",color:white,bold:true},{score:{name:"@s",objective:"evasion_p1"},color:"#ade6ff",bold:true},{"text":"%",color:"#ade6ff",bold:true}]
