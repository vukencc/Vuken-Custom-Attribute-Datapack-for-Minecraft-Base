...
###   "lore.item.intro.copper_leggings.af_show.0":"-1 防御值 +3 最大生命值",
###   "lore.item.intro.copper_leggings.af_show.1":"+20% 近战伤害 -15% 攻击速度",
###   "lore.item.intro.copper_leggings.af_show.2":"-10 抗击退性 +2 防御值",
###   "lore.item.intro.copper_leggings.pf_show.0":"+1 近战保护",
###   "lore.item.intro.copper_leggings.pf_show.1":"+2 弹射物保护",
###   "lore.item.intro.copper_leggings.pf_show.2":"+5 耐久",
