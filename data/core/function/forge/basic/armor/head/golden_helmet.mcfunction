...
###   "lore.item.intro.golden_helmet.af_show.0":"+10% 攻击速度",
###   "lore.item.intro.golden_helmet.af_show.1":"+10% 移动速度",
###   "lore.item.intro.golden_helmet.pf_show.0":"+2 耐久",
###   "lore.item.intro.golden_helmet.pf_show.1":"+1 保护 +1 魔法保护",
