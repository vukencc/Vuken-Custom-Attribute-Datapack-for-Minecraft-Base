...
execute store result score @s temp_marker_1 run data get entity @n[type=item_display,tag=pf_forge_show] item.components."minecraft:custom_data".level
