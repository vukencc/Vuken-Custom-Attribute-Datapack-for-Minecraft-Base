...
execute if entity @s[nbt={SelectedItem:{components:{"minecraft:enchantments":{"core:assistance/chain_break":1}}}}] at @s run function core:custom_ench/assistance/chain_break
