...
execute if entity @s[tag=crit_access] run function core:item_spe/passive/enemy_trigger/take_crit
...
execute at @s on attacker as @s if items entity @s weapon.mainhand *[minecraft:enchantments~[{enchantments:"core:melee/ice_aspect"}]] run tag @n add ice_aspect_ed
execute at @s[tag=ice_aspect_ed] run function core:particle/ench/ice_aspect
