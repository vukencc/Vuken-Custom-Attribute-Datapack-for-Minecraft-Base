...
execute as @s at @s run function core:data_refresh/data_apply with entity @e[limit=1,tag=armor_trans,type=marker,sort=nearest] data
...
execute as @s at @s run function core:data_refresh/agility_apply with entity @n[tag=temp_agility,type=marker] data
...
execute as @s at @s run function core:data_refresh/safe_fall_apply with entity @n[tag=temp_agility,type=marker] data
