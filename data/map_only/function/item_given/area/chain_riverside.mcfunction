...
custom_data={\
IsPotionCharger:1b,NoOffhand:1b,ChestModel:1b,Trigger:1b,Offhand:1b,PotionContainer:[]\
}]
...
custom_data={\
IsPotionCharger:1b,NoOffhand:1b,PotionConsume:1b,Trigger:1b,Offhand:1b,PotionContainer:[]\
}]
